...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  24.63,  24.63 }
    #define DEFAULT_Ki_LIST {   1.91,  1.91 }
    #define DEFAULT_Kd_LIST {  79.47,  79.47 }
  #else
    #define DEFAULT_Kp  24.63
    #define DEFAULT_Ki   1.91
    #define DEFAULT_Kd 79.47
  #endif
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 132.51
  #define DEFAULT_bedKi 25.83
  #define DEFAULT_bedKd 453.23
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, -6, -2.1 }
